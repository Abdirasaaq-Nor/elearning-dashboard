...
import Student_fees from "../Student_fees.json";
...
const columns = [
  ...
  { id: "Parent email", label: "Parent email" },
  { id: "parent phone", label: "parent Phone" },
];
  ...
  return (
    <div className="main">
      <div className="flex flex-col my-4">
        <h2 className="text-2xl pl-4">Account</h2>
